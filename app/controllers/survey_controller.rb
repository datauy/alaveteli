...
class SurveyController < ApplicationController
    ...
    #before_filter :check_survey_key, :only => [ :new, :new_survey_request ]

    skip_filter :authentication_check, :check_in_post_redirect, :only => [ :new_survey_request, :new ]
    ...
    def new
        ...
        # Signing the right user for our control group
        @user = User.authenticate_from_form({:email => 'encuesta@quesabes.org', :password => 'gabita'})
        ...
        # else
        # byebug
            @info_request.user = @user #authenticated_user
        #end
    ...
    def new_request_for_survey
        ...
        # Signing the right user for our control group
        @user = User.authenticate_from_form({:email =>  AlaveteliConfiguration::email_for_control_body , :password =>  AlaveteliConfiguration::password_for_control_body })
